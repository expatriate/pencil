...
var hoverEffect = function hoverEffect(opts) {
  ...
  var texture1 = loader.load(image1, function (texture) {
    ...
    var geometry = new THREE.PlaneBufferGeometry(parent.offsetWidth, elOffsetHeight, 1);
