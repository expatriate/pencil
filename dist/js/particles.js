...
var Birds = function Birds(container, width) {
  var t = this;
  ...
  THREE.BirdGeometry = function () {
    ...
    for (var v = 0; v < triangles * 3; v++) {
      ...
      var c = new THREE.Color(0xCCCCCC + ~~(v / 9) / t.BIRDS * 0xAAAAAA);
  ...
  t.last = performance.now(); //t.SCROLLBOUNDS = window.window.pageYOffset;
...
Birds.prototype.init = function () {
  ...
  var onmove = function onmove(e) {//t.onDocumentMouseMove.call(t,e);
  };
...
Birds.prototype.initComputeRenderer = function () {
  ...
  this.velocityUniforms.scrolltop = {
    value: window.innerHeight / 2
  }; //{value: window.window.pageYOffset};
...
Birds.prototype.initBirds = function () {
  this.geometry = new THREE.BirdGeometry(); // For Vertex and Fragment
